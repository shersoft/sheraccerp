      ...
      if (value != null) {
        setState(() {
          ...
          if (printerType == 9) {
            ...
            _createPDF(
                    printModel,
                    'SalesReturn _ref_${dataInformation['RealEntryNo']}',
                    companySettings,
                    settings,
                    data,
                    customerBalance)
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: const Text('SalesReturn Preview'),
          actions: [
            IconButton(
  ...
  if (model == 3) {
    ...
    taxSale
        ...
        ? pdf.addPage(pw.MultiPage(
            ...
            header: (pw.Context context) => _buildHeaderr(context, settings,
                companySettings, dataLedger, dataInformation),
...
_buildEstimateFooter(pw.Context context, dataBankLedger, dataInformation,
  ...
  return pw.Container(
      ...
      decoration: const pw.BoxDecoration(
        border: pw.Border(
          top: pw.BorderSide(color: pw.PdfColors.black, width: 1),
          right: pw.BorderSide(color: pw.PdfColors.black, width: 1),
          bottom: pw.BorderSide(color: pw.PdfColors.black, width: 1),
          left: pw.BorderSide(color: pw.PdfColors.black, width: 1),
        ),
      ),
      child: pw.Padding(
          padding: const pw.EdgeInsets.all(5),
